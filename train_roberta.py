...
def train(train_dataloader, validation_dataloader, lm, save_dir_root, args):
    return _train_roberta(train_dataloader, validation_dataloader, lm, save_dir_root, args)

def _train_roberta(train_dataloader, validation_dataloader, lm, save_dir_root, args):
    model = lm.model
...
def parse_args():
    ...
    parser.add_argument('--model_path', default='roberta-base')
...
if __name__ == "__main__":
    ...
    model = RobertaLM(args.model_path)
